          ...
          {rows.map((a) => {
            ...
            return (
              <div key={a.id} className="py-4 flex items-start gap-4">
                {a.cover_image_url && (
                  <div className="w-20 h-14 rounded-md overflow-hidden flex-shrink-0 bg-gray-100">
                ...
                <Link
                  href={`/${username}/admin/adventures/${a.slug}`}
                  className="text-xs text-gray-500 hover:text-black px-3 py-1.5 border border-gray-200 rounded-md hover:border-gray-400 transition-colors shrink-0"
                >
                  Edit
                </Link>
              </div>
